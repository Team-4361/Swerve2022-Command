...
public class BatteryManagement extends MainPowerBreaker {
    ...
    /** @return The specific {@link frc.robot.robot_utils.power.PowerBreaker} with an ID, if not found then null. */
    ...
    /** @return The maximum current the {@link frc.robot.robot_utils.power.MainPowerBreaker} is allowed to have. */
