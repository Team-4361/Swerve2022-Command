...
public class StorageExtendIntake extends CommandBase {
    ...
    public void execute() {
        ...
        if (!Robot.intake.isFrontSwitchPressed() /*&& (Robot.intake.getLeftPosition() <= 4 && Robot.intake.getRightPosition() <= 4)*/) {
    ...
    public boolean isFinished() {
        ...
        return Robot.intake.isFrontSwitchPressed() /*|| (Robot.intake.getLeftPosition() > 4 && Robot.intake.getRightPosition() > 4)*/;
    }
}